...
class AdminService {
    async adminRegister(userDetails, res){
        ...
        // Validating Email
        if(!common.validateEmail(userDetails.email)) throw new Error("Invalid email. Please enter a valid email.");
        ...
        // Getting JWT Tokens
        let tokens = AuthService.generateJWTToken(userDetails.username,userDetails.userRole)
